...
x.addEventListener("mouseover",hv,false)
x.addEventListener("mouseout",hv1,false)
y.addEventListener("mouseover",hv,false)
y.addEventListener("mouseout",hv1,false)
function hv(){
    x.style.boxShadow="4px 4px 0 rgba(255,255,255,0.5)";
